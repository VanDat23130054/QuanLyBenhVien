...
/**
 * Data Access Object implementation for Patient entity
 * Handles all database operations for Patient using SQL Server
 */
public class PatientDAO implements IPatientDAO {
    ...
    public Patient getByPhoneNumber(String phoneNumber) {
        String query = "SELECT * FROM Patients WHERE PhoneNumber = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            System.err.println("Error getting patient by phone number: " + e.getMessage());
            e.printStackTrace();
        }
        return null;
    }
